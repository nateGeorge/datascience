...
tags:
  ...
  - data science
header:
  overlay_image: "images/sentiment.jpg"
  image: "images/sentiment.jpg"
  teaser: "images/sentiment.jpg"
  overlay_filter: 0.5
  show_overlay_excerpt: false
  caption: "From [BarnRaisers](https://barnraisersllc.com/2017/01/best-tools-sentiment-analysis-free-fee)"
---
...
where we take the largest probability out of our predictions, and use that as our class prediction.  A detail which can make this incorrect is if we have two classes, we can set the threshold anywhere between 0 and 1 to choose our prediction, meaning our predicted class won't always be the max value.  This is related to [ROC/AUC](http://gim.unmc.edu/dxtests/roc3.htm).
